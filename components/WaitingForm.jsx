      ...
      <>
         {!formSubmitted && (
            <div className='w-full mt-8 lg:pl-6 xl:pl-8 2xl:pl-12 lg:mt-0'>
               ...
               <form
                  className='flex flex-col items-center justify-center max-w-md lg:max-w-full'
               ...
               >
                  <div className='w-full space-y-4 lg:grid lg:grid-cols-2 lg:gap-6 lg:space-y-0'>
                     ...
                     >
                        ...
                        />
                        Yes, I will like to receive news, updates and messages
                        from Ace Games
                     </label>
                  </div>
         ...
         {formSubmitted && (
            <div className='w-full mt-8 text-center flex items-center justify-center flex-col lg:mt-0'>
               <h4 className='mb-2 text-base font-bold lg:text-3xl lg:mb-4'>
                  Thank you for your interest in Ace Games.
               </h4>
               <p className='mb-2 text-base lg:text-xl lg:mb-4 text-gray-600'>
